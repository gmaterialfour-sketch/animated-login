...
<head>
  ...
  <link rel="stylesheet" href="${url.resourcesPath}/assets/css/modern-effects.css?v=1.4">
  <link rel="shortcut icon" type="image/png" href="${url.resourcesPath}/assets/images/logos/favicon.png?v=2">
  <link rel="icon" type="image/png" href="${url.resourcesPath}/assets/images/logos/favicon.png?v=2">
</head>
<body>
  <main class="pmo-login">
    ...
    <div class="container">
        ...
        <div class="access-title">
          <span class="access-icon" aria-hidden="true">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
              <path d="M12 11c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM12 13c-2.209 0-4 1.791-4 4v2h8v-2c0-2.209-1.791-4-4-4z" />
            </svg>
          </span>
          PMO MASTER ACCESS
        </div>
      ...
      <section class="login-panel" aria-label="Log-In">
        <div class="pmo-card">
          <div class="card-icon animated-icon" aria-hidden="true">
          ...
          <form id="kc-form-login" action="${url.loginAction}" method="post" novalidate>
            ...
            <div class="field-group">
              ...
              <div class="input-shell">
                ...
                <input id="password" name="password" type="password" autocomplete="current-password" required aria-describedby="password-error" placeholder="Password">
  ...
  <script type="module" src="${url.resourcesPath}/assets/js/modern-animations.js?v=1.4"></script>
</body>
</html>
